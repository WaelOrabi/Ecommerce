...
namespace Ecommerce.Application.DTO.RequestsDTO.CartItem
{
    public class CartItemValidation : AbstractValidator<CartItemRequest>
    {
        private readonly IStringLocalizer<SharedResources> _localizer;
        private readonly IProductService _productService;

        public CartItemValidation(IStringLocalizer<SharedResources> localizer, IProductService productService)
        {
